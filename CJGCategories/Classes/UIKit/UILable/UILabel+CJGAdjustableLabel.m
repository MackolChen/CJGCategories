...
// it is ignored.
// =====================================================
- (void)cjg_adjustLabelToMaximumSize:(CGSize)maxSize
...
- (void)cjg_adjustLabelToMaximumSize:(CGSize)maxSize
                 minimumFontSize:(int)minFontSize
{
  [self cjg_adjustLabelToMaximumSize:maxSize
...
// =====================================================
- (void)cjg_adjustLabelSizeWithMinimumFontSize:(int)minFontSize
{
  [self cjg_adjustLabelToMaximumSize:CGSizeZero
                     minimumSize:CGSizeZero 
                 minimumFontSize:minFontSize];
}
