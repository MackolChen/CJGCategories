...
*/
@interface UIImage (CJGAnimatedGIF)

/*
        UIImage *animation = [UIImage cjg_animatedImageWithAnimatedGIFData:theData];
...
*/
+ (UIImage *)cjg_animatedImageWithAnimatedGIFData:(NSData *)theData;

/*
        UIImage *image = [UIImagecjg_ animatedImageWithAnimatedGIFURL:theURL];
...
*/
+ (UIImage *)cjg_animatedImageWithAnimatedGIFURL:(NSURL *)theURL;
