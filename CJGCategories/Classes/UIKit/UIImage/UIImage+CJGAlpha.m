 ...
 */
- (UIImage *)cjg_imageWithAlpha {
    if ([self cjg_hasAlpha]) {
        return self;
    }
 ...
 *  @return 增加透明边框后的图片
 */
- (UIImage *)cjg_transparentBorderImage:(NSUInteger)borderSize {
    ...
    CGImageRef maskImageRef = [self cjg_newBorderMask:borderSize size:newRect.size];
