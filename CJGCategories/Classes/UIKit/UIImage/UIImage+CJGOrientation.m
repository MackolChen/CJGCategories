...
- (UIImage *)cjg_flip:(BOOL)isHorizontal {
...
{
    return [self cjg_imageRotatedByDegrees:[UIImage cjg_radiansToDegrees:radians]];
}
/**
 *  @brief  旋转图片
 *
...
- (UIImage *)cjg_imageRotatedByDegrees:(CGFloat)degrees
{
    ...
    CGAffineTransform t = CGAffineTransformMakeRotation([UIImage cjg_degreesToRadians:degrees]);
    ...
    CGContextRotateCTM(bitmap, [UIImage cjg_degreesToRadians:degrees]);
