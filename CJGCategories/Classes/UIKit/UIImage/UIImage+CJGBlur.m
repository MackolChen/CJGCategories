...
@implementation UIImage (CJGBlur)
#pragma mark -
#pragma mark - Effects
...
- (UIImage *)cjg_lightImage
{
    ...
    return [self cjg_blurredImageWithSize:CGSizeMake(60, 60) tintColor:tintColor saturationDeltaFactor:1.8 maskImage:nil];
}
...
- (UIImage *)cjg_extraLightImage
{
    ...
    return [self cjg_blurredImageWithSize:CGSizeMake(40, 40) tintColor:tintColor saturationDeltaFactor:1.8 maskImage:nil];
}
...
- (UIImage *)cjg_tintedImageWithColor:(UIColor *)tintColor
{
    ...
    return [self cjg_blurredImageWithSize:CGSizeMake(20, 20) tintColor:effectColor saturationDeltaFactor:-1.0 maskImage:nil];
}
...
{
    return [self cjg_blurredImageWithSize:CGSizeMake(blurRadius, blurRadius)];
}
...
{
    return [self cjg_blurredImageWithSize:blurSize tintColor:nil saturationDeltaFactor:1.0 maskImage:nil];
}
...
//| ----------------------------------------------------------------------------
- (UIImage *)cjg_blurredImageWithSize:(CGSize)blurSize tintColor:(UIColor *)tintColor saturationDeltaFactor:(CGFloat)saturationDeltaFactor maskImage:(UIImage *)maskImage
{
...
#define ENABLE_TINT                     1
    ...
    if (hasBlur || hasSaturationChange)
    {
        ...
        if (hasBlur)
        {
            CGFloat radiusX = [self cjg_gaussianBlurRadiusWithBlurRadius:blurSize.width * inputImageScale];
            CGFloat radiusY = [self cjg_gaussianBlurRadiusWithBlurRadius:blurSize.height * inputImageScale];
        ...
        if ( (effectCGImage = vImageCreateCGImageFromBuffer(inputBuffer, &format, &cjg_cleanupBuffer, NULL, kvImageNoAllocate, NULL)) == NULL ) {
...
//
- (CGFloat)cjg_gaussianBlurRadiusWithBlurRadius:(CGFloat)blurRadius
{
...
//
void cjg_cleanupBuffer(void *userData, void *buf_data)
{ free(buf_data); }
