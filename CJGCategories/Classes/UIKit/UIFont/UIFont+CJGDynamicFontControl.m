...
+(UIFont *)cjg_preferredFontForTextStyle:(NSString *)style withFontName:(NSString *)fontName scale:(CGFloat)scale{
    ...
    return [font cjg_adjustFontForTextStyle:style];

}

-(UIFont *)cjg_adjustFontForTextStyle:(NSString *)style{
    return [self cjg_adjustFontForTextStyle:style scale:1.0f];
}

-(UIFont *)cjg_adjustFontForTextStyle:(NSString *)style scale:(CGFloat)scale{
