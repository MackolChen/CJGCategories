...
@implementation UIFont (CJGTTF)

+ (UIFont *)cjg_fontWithTTFAtURL:(NSURL *)URL size:(CGFloat)size{
	...
	return [UIFont cjg_fontWithTTFAtPath:URL.path size:size];
}

+ (UIFont *)cjg_fontWithTTFAtPath:(NSString *)path size:(CGFloat)size{
