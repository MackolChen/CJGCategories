...
static void CJGSVGApplier(void* info, const CGPathElement* element);
...
- (NSString*)cjg_SVGString
{
    ...
    CGPathApply(path, (__bridge_retained void*)SVGString, CJGSVGApplier);
    NSString *lineCap;
