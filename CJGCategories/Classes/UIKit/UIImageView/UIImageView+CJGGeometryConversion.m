...
- (CGRect)cjg_convertRectFromImage:(CGRect)imageRect {
    ...
    CGPoint viewTopLeft     = [self cjg_convertPointFromImage:imageTopLeft];
    CGPoint viewBottomRight = [self cjg_convertPointFromImage:imageBottomRight];
...
- (CGRect)cjg_convertRectFromView:(CGRect)viewRect {
    ...
    CGPoint imageTopLeft = [self cjg_convertPointFromView:viewTopLeft];
    CGPoint imageBottomRight = [self cjg_convertPointFromView:viewBottomRight];
