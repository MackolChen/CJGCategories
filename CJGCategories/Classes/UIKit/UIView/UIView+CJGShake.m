...
- (void)cjg_shake {
    [self _cjg_shake:10 direction:1 currentTimes:0 withDelta:5 speed:0.03 shakeDirection:JKShakeDirectionHorizontal completion:nil];
}

- (void)cjg_shake:(int)times withDelta:(CGFloat)delta {
    [self _cjg_shake:times direction:1 currentTimes:0 withDelta:delta speed:0.03 shakeDirection:JKShakeDirectionHorizontal completion:nil];
}

- (void)cjg_shake:(int)times withDelta:(CGFloat)delta completion:(void(^)(void))handler {
    [self _cjg_shake:times direction:1 currentTimes:0 withDelta:delta speed:0.03 shakeDirection:JKShakeDirectionHorizontal completion:handler];
}

- (void)cjg_shake:(int)times withDelta:(CGFloat)delta speed:(NSTimeInterval)interval {
    [self _cjg_shake:times direction:1 currentTimes:0 withDelta:delta speed:interval shakeDirection:JKShakeDirectionHorizontal completion:nil];
}

- (void)cjg_shake:(int)times withDelta:(CGFloat)delta speed:(NSTimeInterval)interval completion:(void(^)(void))handler {
    [self _cjg_shake:times direction:1 currentTimes:0 withDelta:delta speed:interval shakeDirection:JKShakeDirectionHorizontal completion:handler];
}
...
- (void)_cjg_shake:(int)times direction:(int)direction currentTimes:(int)current withDelta:(CGFloat)delta speed:(NSTimeInterval)interval shakeDirection:(JKShakeDirection)shakeDirection completion:(void (^)(void))completionHandler {
