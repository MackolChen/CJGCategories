...
- (id)cjg_findSuperViewWithSuperViewClass:(Class)clazz
{
    if (self == nil) {
        ...
        return [self.superview cjg_findSuperViewWithSuperViewClass:clazz];
    }
}
/**
...
- (BOOL)cjg_findAndResignFirstResponder {
    ...
    for (UIView *v in self.subviews) {
        if ([v cjg_findAndResignFirstResponder]) {
            return YES;
        }
    }
...
- (UIView *)cjg_findFirstResponder {
    ...
    for (UIView *v in self.subviews) {
        UIView *fv = [v cjg_findFirstResponder];
        if (fv) {
            return fv;
        }
    }
 ...
 */
- (UIViewController *)cjg_viewController
{
