...
- (void)cjg_addTopBorderWithColor:(UIColor *)color width:(CGFloat)borderWidth {
    [self cjg_addTopBorderWithColor:color width:borderWidth excludePoint:0 edgeType:0];
}


- (void)cjg_addLeftBorderWithColor:(UIColor *)color width:(CGFloat)borderWidth {
    [self cjg_addLeftBorderWithColor:color width:borderWidth excludePoint:0 edgeType:0];
}


- (void)cjg_addBottomBorderWithColor:(UIColor *)color width:(CGFloat) borderWidth {
    [self cjg_addBottomBorderWithColor:color width:borderWidth excludePoint:0 edgeType:0];
}


- (void)cjg_addRightBorderWithColor:(UIColor *)color width:(CGFloat)borderWidth {
    [self cjg_addRightBorderWithColor:color width:borderWidth excludePoint:0 edgeType:0];
}
