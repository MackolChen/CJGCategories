...
+ (NSString *)cjg_platformString{
    NSString *platform = [self cjg_platform];
...
+ (NSUInteger)cjg_getSysInfo:(uint)typeSpecifier
{
...
+ (NSUInteger)cjg_cpuFrequency {
    return [self cjg_getSysInfo:HW_CPU_FREQ];
}

+ (NSUInteger)cjg_busFrequency {
    return [self cjg_getSysInfo:HW_BUS_FREQ];
}

+ (NSUInteger)cjg_ramSize {
    return [self cjg_getSysInfo:HW_MEMSIZE];
}

+ (NSUInteger)cjg_cpuNumber {
    return [self cjg_getSysInfo:HW_NCPU];
}


+ (NSUInteger)cjg_totalMemoryBytes
{
    return [self cjg_getSysInfo:HW_PHYSMEM];
}
