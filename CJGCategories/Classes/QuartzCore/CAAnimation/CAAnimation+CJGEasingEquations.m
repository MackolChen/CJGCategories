...
@implementation CAAnimation (CJGEasingEquations)
...
+ (void)cjg_addAnimationToLayer:(CALayer *)layer
                   duration:(CGFloat)duration
                  transform:(CATransform3D)transform
             easingFunction:(CAAnimationEasingFunction)easingFunction
{
    CAAnimation *animation = [self cjg_transformAnimationWithDuration:duration
...
+ (CAKeyframeAnimation*)cjg_animationWithKeyPath:(NSString*)keyPath
                                    duration:(CGFloat)duration
...
+ (void)cjg_addAnimationToLayer:(CALayer *)layer
             ...
             easingFunction:(CAAnimationEasingFunction)easingFunction
{
    [self cjg_addAnimationToLayer:layer
                  withKeyPath:keyPath
                     duration:duration
...
+ (void)cjg_addAnimationToLayer:(CALayer *)layer
             ...
             easingFunction:(CAAnimationEasingFunction)easingFunction
{
    CAAnimation *animation = [self cjg_animationWithKeyPath:keyPath
                                               duration:duration
                                                   from:startValue
                                                     to:endValue
                                         easingFunction:easingFunction];
