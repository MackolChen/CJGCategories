...
+ (void)cjg_initializeEmojiCheatCodes
{
    ...
    @synchronized(self) {
        cjg_s_unicodeToCheatCodes = forwardMap;
        cjg_s_cheatCodesToUnicode = [reversedMap copy];
    }
}

- (NSString *)cjg_stringByReplacingEmojiCheatCodesWithUnicode
{
    if (!cjg_s_cheatCodesToUnicode) {
        [NSString cjg_initializeEmojiCheatCodes];
    }
    
    if ([self rangeOfString:@":"].location != NSNotFound) {
        __block NSMutableString *newText = [NSMutableString stringWithString:self];
        [cjg_s_cheatCodesToUnicode enumerateKeysAndObjectsUsingBlock:^(NSString *key, id obj, BOOL *stop) {
...
- (NSString *)cjg_stringByReplacingEmojiUnicodeWithCheatCodes
{
    ...
    if (self.length) {
        __block NSMutableString *newText = [NSMutableString stringWithString:self];
        [cjg_s_unicodeToCheatCodes enumerateKeysAndObjectsUsingBlock:^(id key, id obj, BOOL *stop) {
