...
@implementation NSString (CJGMIME)
/**
...
- (NSString *)cjg_MIMEType {
    return [[self class] cjg_MIMETypeForExtension:[self pathExtension]];
}

+ (NSString *)cjg_MIMETypeForExtension:(NSString *)extension {
    return [[self cjg_MIMEDict] valueForKey:[extension lowercaseString]];
}
/**
 *  @brief  常见MIME集合
 *
