...
+ (instancetype)cjg_objectWithContentsOfFile:(NSString *)filePath
{
    //load the file
...
- (BOOL)cjg_writeToFile:(NSString *)filePath atomically:(BOOL)useAuxiliaryFile
{
...
+ (NSDictionary *)cjg_codableProperties
{
    //deprecated
...
- (NSDictionary *)cjg_codableProperties
{
    ...
    if (!codableProperties)
    {
        ...
        {
            [(NSMutableDictionary *)codableProperties addEntriesFromDictionary:[subclass cjg_codableProperties]];
...
- (NSDictionary *)cjg_dictionaryRepresentation
{
    NSMutableDictionary *dict = [NSMutableDictionary dictionary];
    for (__unsafe_unretained NSString *key in [self cjg_codableProperties])
    {
...
- (void)cjg_setWithCoder:(NSCoder *)aDecoder
{
    BOOL secureAvailable = [aDecoder respondsToSelector:@selector(decodeObjectOfClass:forKey:)];
    BOOL secureSupported = [[self class] supportsSecureCoding];
    NSDictionary *properties = [self cjg_codableProperties];
...
{
    [self cjg_setWithCoder:aDecoder];
    return self;
}
#pragma clang diagnostic pop
- (void)encodeWithCoder:(NSCoder *)aCoder
{
    for (NSString *key in [self cjg_codableProperties])
    {
