...
{
  return [self cjg_fetchObjectsForEntity:entity predicate:nil sortDescriptors:nil];
}

- (NSArray *)cjg_fetchObjectsForEntity:(NSString *)entity predicate:(NSPredicate *)predicate
{
  return [self cjg_fetchObjectsForEntity:entity predicate:predicate sortDescriptors:nil];
}

- (NSArray *)cjg_fetchObjectsForEntity:(NSString *)entity sortDescriptors:(NSArray *)sortDescriptors
{
  return [self cjg_fetchObjectsForEntity:entity predicate:nil sortDescriptors:sortDescriptors];
}
...
- (NSArray *)cjg_fetchObjectsForEntity:(NSString *)entity predicate:(NSPredicate *)predicate sortDescriptors:(NSArray *)sortDescriptors {
  return [self cjg_fetchObjectsForEntity:entity predicate:predicate sortDescriptors:sortDescriptors fetchLimit:0];
}
...
{
  NSFetchRequest *request = [NSFetchRequest cjg_fetchRequestWithEntity:[NSEntityDescription entityForName:entity inManagedObjectContext:self] predicate:predicate sortDescriptors:sortDescriptors];
  if (limit > 0)
...
{
  return [self cjg_fetchObjectForEntity:entity predicate:nil sortDescriptors:nil];
}

- (id)cjg_fetchObjectForEntity:(NSString *)entity predicate:(NSPredicate *)predicate
{
  return [self cjg_fetchObjectForEntity:entity predicate:predicate sortDescriptors:nil];
}

- (id)cjg_fetchObjectForEntity:(NSString *)entity sortDescriptors:(NSArray *)sortDescriptors
{
  return [self cjg_fetchObjectForEntity:entity predicate:nil sortDescriptors:sortDescriptors];
}

- (id)cjg_fetchObjectForEntity:(NSString *)entity predicate:(NSPredicate *)predicate sortDescriptors:(NSArray *)sortDescriptors
{
  NSArray *results = [self cjg_fetchObjectsForEntity:entity predicate:predicate sortDescriptors:sortDescriptors];
  if (results.count < 1)
    return nil;
...
{
  [self cjg_fetchObjectsForEntity:entity predicate:nil sortDescriptors:nil callback:callback];
}

- (void)cjg_fetchObjectsForEntity:(NSString *)entity predicate:(NSPredicate *)predicate callback:(FetchObjectsCallback)callback
{
  [self cjg_fetchObjectsForEntity:entity predicate:predicate sortDescriptors:nil callback:callback];
}
...
{
  [self cjg_fetchObjectsForEntity:entity predicate:nil sortDescriptors:sortDescriptors callback:callback];
}
...
- (void)cjg_fetchObjectsForEntity:(NSString *)entity predicate:(NSPredicate *)predicate sortDescriptors:(NSArray *)sortDescriptors callback:(FetchObjectsCallback)callback
{
  ...
  [self cjg_fetchRequest:request withCallback:callback];
}

- (void)cjg_fetchObjectForEntity:(NSString *)entity callback:(FetchObjectCallback)callback
{
  [self cjg_fetchObjectForEntity:entity predicate:nil sortDescriptors:nil callback:callback];
}

- (void)cjg_fetchObjectForEntity:(NSString *)entity predicate:(NSPredicate *)predicate callback:(FetchObjectCallback)callback
{
  [self cjg_fetchObjectForEntity:entity predicate:predicate sortDescriptors:nil callback:callback];
}
...
{
  [self cjg_fetchObjectForEntity:entity predicate:nil sortDescriptors:sortDescriptors callback:callback];
}
...
{
  [self cjg_fetchObjectsForEntity:entity predicate:predicate sortDescriptors:sortDescriptors callback:^(NSArray *objects, NSError *error) {
    id object = nil;
...
- (void)cjg_deleteEntity:(NSString *)entity withPredicate:(NSPredicate *)predicate
{
  ...
  NSFetchRequest *fetchRequest = [NSFetchRequest cjg_fetchRequestWithEntity:[NSEntityDescription entityForName:entity inManagedObjectContext:self] predicate:predicate];
